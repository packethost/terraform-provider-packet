...
func resourceMetalVolumeCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceMetalVolumeRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*packngo.Client)
...
func resourceMetalVolumeUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*packngo.Client)
